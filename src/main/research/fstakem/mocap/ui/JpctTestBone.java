...
public class JpctTestBone extends JpctGraphicsObject
{
	private static final float OBJECT_SCALE = 5.0f;
	private static final float OBJECT_HEIGHT = 5.0f; 
	
	public JpctTestBone(Bone bone)
	{
		Object3D object = Primitives.getBox(JpctTestBone.OBJECT_SCALE, JpctTestBone.OBJECT_HEIGHT);
